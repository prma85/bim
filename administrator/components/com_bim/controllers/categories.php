 ...
 * @since  1.6
 */
class BimControllerCategories extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_bim&view=categories');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'category', $prefix = 'BimModel', $config = array())
	{
