 ...
 * @since  1.6
 */
class BimControllerGoals extends JControllerAdmin {

    /**
     * Method to clone existing Goals
     *
     * @return void
     */
    public function duplicate() {
        ...
        $this->setRedirect('index.php?option=com_bim&view=goals');
    }
     ...
     * @since    1.6
     */
    public function getModel($name = 'goal', $prefix = 'BimModel', $config = array()) {
