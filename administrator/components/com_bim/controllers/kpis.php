...
/**
 * Kpis list controller class.
 *
 * @since  1.6
 */
class BimControllerKpis extends JControllerAdmin {

    /**
     * Method to clone existing Kpis
     *
     * @return void
     */
    public function duplicate() {
        ...
        $this->setRedirect('index.php?option=com_bim&view=kpis');
    }
     ...
     * @since    1.6
     */
    public function getModel($name = 'kpi', $prefix = 'BimModel', $config = array()) {
