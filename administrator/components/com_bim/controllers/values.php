...
/**
 * Values list controller class.
 *
 * @since  1.6
 */
class BimControllerValues extends JControllerAdmin {

    /**
     * Method to clone existing Values
     *
     * @return void
     */
    public function duplicate() {
        ...
        $this->setRedirect('index.php?option=com_bim&view=values');
    }
     ...
     * @since    1.6
     */
    public function getModel($name = 'value', $prefix = 'BimModel', $config = array()) {
