 ...
 * @since  1.6
 */
class BimControllerAudits extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_bim&view=audits');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'audit', $prefix = 'BimModel', $config = array())
	{
