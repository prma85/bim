...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_bim&task=categories.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_bim&view=categories'); ?>" method="post"
            ...
            <table class="table table-striped" id="categoryList">
                <thead>
                    <tr>
                        ...
                        <th class='left'>
                            <?php echo JHtml::_('grid.sort', 'COM_BIM_CATEGORIES_ID', 'a.`id`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                            <?php echo JHtml::_('grid.sort', 'COM_BIM_CATEGORIES_TITLE', 'a.`title`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                            <?php echo JHtml::_('grid.sort', 'COM_BIM_CATEGORIES_PARENT_ID', 'a.`parent_id`', $listDirn, $listOrder); ?>
                        </th>
                    </tr>
                </thead>
                <tfoot>
                    ...
                    foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td>
                                ...
                                <?php endif; ?>
                                <?php if ($canEdit) : ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_bim&task=category.edit&id=' . (int) $item->id); ?>">
