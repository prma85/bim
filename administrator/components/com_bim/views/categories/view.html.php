 ...
 * @since  1.6
 */
class BimViewCategories extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        BimHelper::addSubmenu('categories');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_BIM_TITLE_CATEGORIES'), 'categories.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_bim&view=categories');
        ...
        //Filter for the field parent_id;
        jimport('joomla.form.form');
        $options = array();
        JForm::addFormPath(JPATH_COMPONENT . '/models/forms');
        $form = JForm::getInstance('com_bim.category', 'category');

        $field = $form->getField('parent_id');

        $query = $form->getFieldAttribute('filter_parent_id', 'query');
        $translate = $form->getFieldAttribute('filter_parent_id', 'translate');
        $key = $form->getFieldAttribute('filter_parent_id', 'key_field');
        $value = $form->getFieldAttribute('filter_parent_id', 'value_field');
        ...
        JHtmlSidebar::addFilter(
                '$Parent', 'filter_parent_id', JHtml::_('select.options', $options, "value", "text", $this->state->get('filter.parent_id')), true
        );
    }
    ...
    protected function getSortFields() {
        return array(
            ...
            'a.`title`' => JText::_('COM_BIM_CATEGORIES_TITLE'),
            'a.`parent_id`' => JText::_('COM_BIM_CATEGORIES_PARENT_ID'),
        );
    }
