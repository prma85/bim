 ...
 * @since  1.6
 */
class BimViewCategory extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_BIM_TITLE_CATEGORY'), 'category.png');
        ...
        if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
            JToolbarHelper::versions('com_bim.category', $this->item->id);
        }
