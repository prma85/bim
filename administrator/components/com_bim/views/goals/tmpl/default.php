...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_bim&task=goals.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_bim&view=goals'); ?>" method="post"
      name="adminForm" id="adminForm">
        ...
        <?php else : ?>
            ...
            <table class="table table-striped" id="goalList">
                <thead>
                    <tr>
                        ...
                        <th class='left'>
                            <?php echo JHtml::_('grid.sort', 'COM_BIM_GOALS_ID', 'a.`id`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                            <?php echo JHtml::_('grid.sort', 'COM_BIM_GOALS_YEAR', 'a.`year`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                            <?php echo JHtml::_('grid.sort', 'COM_BIM_GOALS_KPI', 'a.`kpi`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                            <?php echo JHtml::_('grid.sort', 'COM_BIM_GOALS_CREATED_BY', 'a.`created_by`', $listDirn, $listOrder); ?>
                        </th>
                    </tr>
                </thead>
                <tfoot>
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td>
                                <?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
                                    <?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'goals.', $canCheckin); ?>
                                <?php endif; ?>
                                <?php if ($canEdit) : ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_bim&task=goal.edit&id=' . (int) $item->id); ?>">
