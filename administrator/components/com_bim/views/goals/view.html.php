 ...
 * @since  1.6
 */
class BimViewGoals extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_BIM_TITLE_GOALS'), 'goals.png');
        ...
        if (file_exists($formPath)) {
            if ($canDo->get('core.create')) {
                ...
                JToolbarHelper::custom('goals.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
            }
        ...
        JHtmlSidebar::setAction('index.php?option=com_bim&view=goals');
        ...
        $form = JForm::getInstance('com_bim.goal', 'goal');
    ...
    protected function getSortFields() {
        return array(
            ...
            'a.`created_by`' => JText::_('COM_BIM_GOALS_CREATED_BY'),
            'a.`kpi`' => JText::_('COM_BIM_GOALS_KPI'),
            'a.`year`' => JText::_('COM_BIM_GOALS_YEAR'),
        );
    }
