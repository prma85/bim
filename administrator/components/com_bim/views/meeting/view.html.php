 ...
 * @since  1.6
 */
class BimViewMeeting extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_BIM_TITLE_MEETING'), 'meeting.png');
        ...
        if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
            JToolbarHelper::versions('com_bim.meeting', $this->item->id);
        }
