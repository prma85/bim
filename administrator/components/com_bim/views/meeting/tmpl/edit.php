...
<form
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_BIM_TITLE_MEETING', true)); ?>
		<div class="row-fluid">
			...
			<?php
				...
				endforeach;
			?>			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('participants'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('participants'); ?></div>
			</div>
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('facts'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('facts'); ?></div>
			</div>
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('causes'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('causes'); ?></div>
			</div>
			<div class="control-group">
