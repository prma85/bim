 ...
 * @since  1.6
 */
class BimModelDefault extends JModelList
{
	/**
	...
	public function getItems()
	{
		...
		foreach ($items as $oneItem) {
			...
			if (isset($oneItem->objective)) {
				$values = explode(',', $oneItem->objective);
			...
			$oneItem->objective = !empty($textValue) ? implode(', ', $textValue) : $oneItem->objective;
