 ...
 * @since  1.6
 */
class BimTableCategory extends JTable {
    ...
    public function __construct(&$db) {
        JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'BimTableCategory', array('typeAlias' => 'com_bim.category'));
        parent::__construct('#__bim_category', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
        ...
        if (!JFactory::getUser()->authorise('core.admin', 'com_bim.category.' . $array['id'])) {
            $actions = JAccess::getActionsFromFile(
                            JPATH_ADMINISTRATOR . '/components/com_bim/access.xml', "/access/section[@name='category']/"
            );
            $default_actions = JAccess::getAssetRules('com_bim.category.' . $array['id'])->getData();
            $array_jaccess = array();
    ...
    protected function _getAssetName() {
        ...
        return 'com_bim.category.' . (int) $this->$k;
    }
