...
$document->addStyleSheet(JUri::root() . 'media/com_test/css/list.css');
...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_test&task=items.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_test&view=items'); ?>" method="post"
	...
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'items.', $canChange, 'cb'); ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_test&task=item.edit&id='.(int) $item->id); ?>">
