...
if (empty($list['direction']))
{
	...
	protected function getListQuery()
	{
		...
		if (!JFactory::getUser()->authorise('core.edit', 'com_test'))
		{
...
$query->where('( a.title LIKE '.$search.' )');
		...
		foreach ($items as $item)
		{
			...
			if (isset($item->category))
			{
				...
				// Get the title of that particular template
					$title = TestFrontendHelper::getCategoryNameByCategoryId($item->category);
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_TEST_SEARCH_FILTER_DATE_FORMAT"), "warning");
